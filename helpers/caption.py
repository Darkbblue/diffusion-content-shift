...
def setup_model_and_processor(calc_clip):
  ...
  clip_model = None
  if calc_clip:
    clip_processor = CLIPProcessor.from_pretrained("/data/benyuan/diffusion-feature/models/clip",device_map="cuda")
    clip_model = CLIPModel.from_pretrained("/data/benyuan/diffusion-feature/models/clip",device_map="cuda")
  model = AutoModelForVision2Seq.from_pretrained("/data/benyuan/diffusion-feature/models/kosmos",device_map="cuda")
  processor = AutoProcessor.from_pretrained("/data/benyuan/diffusion-feature/models/kosmos",device_map="cuda")
